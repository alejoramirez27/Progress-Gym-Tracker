  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-img-panel">
        ...
        {/* Bottom fade for branding text legibility */}
      ...
      <div className="auth-form-panel">
        <div className="auth-form-card">
          ...
          <div style={{ marginBottom: '20px' }}>
            <h1 style={{ fontSize: '18px', fontWeight: '700', color: '#111318', letterSpacing: '-0.03em', margin: '0 0 4px' }}>Crear cuenta</h1>
            <p style={{ fontSize: '12px', color: '#7a8290', margin: 0 }}>Completa los datos para empezar</p>
          </div>
          ...
          <form onSubmit={handleRegistro} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input id="r-nombre" type="text" value={nombre} onChange={e => { setNombre(e.target.value); if (error) setError('') }} placeholder="Tu nombre" autoComplete="name"
